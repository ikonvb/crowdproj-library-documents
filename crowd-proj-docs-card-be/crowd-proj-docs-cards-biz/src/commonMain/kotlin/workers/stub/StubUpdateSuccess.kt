...
fun CorChainDsl<MkPlcDocCardContext, Unit>.stubUpdateSuccess(title: String, corSettings: MkPlcCorSettings) = worker {
    ...
    handle {
        ...
        logger.doWithLogging(id = this.requestId.asString(), LogLevel.DEBUG) {
            ...
            val stub = MkPlcDocCardStubSingleton.prepareResult {
                ...
                mkPlcDocCardRequest.visibility.takeIf { it != MkPlcVisibility.NONE }?.also { this.visibility = it }
            }
