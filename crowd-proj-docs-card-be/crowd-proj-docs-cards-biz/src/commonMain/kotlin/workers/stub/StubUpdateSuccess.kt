...
fun CorChainDsl<MkPlcDocCardContext, Unit>.stubUpdateSuccess(title: String, corSettings: MkPlcDocCardCorSettings) = worker {
    ...
    handle {
        ...
        logger.doWithLogging(id = this.requestId.asString(), LogLevel.DEBUG) {
            ...
            val stub = MkPlcDocCardStubSingleton.prepareResult {
                ...
                mkPlcDocCardRequest.visibility.takeIf { it != MkPlcDocCardVisibility.NONE }?.also { this.visibility = it }
            }
